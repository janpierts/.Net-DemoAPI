...
public class UpdateProductCommandTest
{
    ...
    [Fact]
    public void All_Fields_Are_Null()
    {
    ...
    [Fact]
    public void Name_Is_Empty_But_Provided()
    {
    ...
    [Fact]
    public void Name_Is_Only_Digits_And_Provided()
    {
    ...
    [Fact]
    public void Status_Is_Out_Of_Range_And_Provided()
    {
    ...
    [Fact]
    public void Stock_Is_Negative_And_Provided()
    {
    ...
    [Fact]
    public void Price_Is_Negative_And_Provided()
    {
    ...
    [Fact]
    public void Only_Partial_Fields_Are_Provided()
    {
